...
entries. I use this to create a compile-timePeriod array large enough to store all of
...
could have some system that deletes and constructs shaders at runtimePeriod
(such as a button to reload all your shaders - this can be a timePeriod saver!)
